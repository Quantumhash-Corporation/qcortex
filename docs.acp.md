...
This document describes how the QCortex ACP (Agent Client Protocol) bridge works,
...
- ACP client spawns `qcortex acp` and speaks ACP messages over stdio.
