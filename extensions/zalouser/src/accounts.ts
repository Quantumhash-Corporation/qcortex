...
import type { QCortexConfig } from "qcortex/plugin-sdk/zalouser";
...
export function listZalouserAccountIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: QCortexConfig): string {
...
function mergeZalouserAccountConfig(cfg: QCortexConfig, accountId: string): ZalouserAccountConfig {
