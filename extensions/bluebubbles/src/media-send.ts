...
import { resolveChannelMediaMaxBytes, type QCortexConfig } from "qcortex/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: QCortexConfig; accountId?: string }): string[] {
