...
import type { QCortexConfig } from "qcortex/plugin-sdk/bluebubbles";
...
export function listBlueBubblesAccountIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: QCortexConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: QCortexConfig): ResolvedBlueBubblesAccount[] {
