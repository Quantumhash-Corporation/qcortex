import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "qcortex/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
...
function setBlueBubblesDmPolicy(cfg: QCortexConfig, dmPolicy: DmPolicy): QCortexConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your QCortex gateway URL + webhook path",
