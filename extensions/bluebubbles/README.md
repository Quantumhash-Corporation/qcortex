...
This directory contains the **BlueBubbles external channel plugin** for QCortex.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `qcortex/plugin-sdk` helpers.
