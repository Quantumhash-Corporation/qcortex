import type { LineChannelData, QCortexPluginApi, ReplyPayload } from "qcortex/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: QCortexPluginApi): void {
  api.registerCommand({
    name: "card",
