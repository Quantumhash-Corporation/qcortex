import type { QCortexConfig, PluginRuntime, ResolvedLineAccount } from "qcortex/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: QCortexConfig; accountId: string }): Promise<{
