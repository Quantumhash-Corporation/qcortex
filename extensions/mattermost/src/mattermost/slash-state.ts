...
import type { QCortexPluginApi } from "qcortex/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("qcortex/plugin-sdk/mattermost").QCortexConfig;
    runtime: import("qcortex/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: QCortexPluginApi) {
