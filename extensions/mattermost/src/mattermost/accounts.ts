...
import type { QCortexConfig } from "qcortex/plugin-sdk/mattermost";
...
export function listMattermostAccountIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: QCortexConfig): string {
...
export function listEnabledMattermostAccounts(cfg: QCortexConfig): ResolvedMattermostAccount[] {
