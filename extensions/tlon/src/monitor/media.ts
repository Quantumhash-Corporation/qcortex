...
import { fetchWithSsrFGuard } from "qcortex/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to QCortex workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".qcortex", "workspace", "media", "inbound");
 ...
 * Format matches QCortex's expected attachment structure.
 */
