...
vi.mock("qcortex/plugin-sdk/tlon", async (importOriginal) => {
  const actual = await importOriginal<typeof import("qcortex/plugin-sdk/tlon")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  ...
  it("fetches image and calls uploadFile, returns uploaded URL", async () => {
    const { fetchWithSsrFGuard } = await import("qcortex/plugin-sdk/tlon");
