import type {
  ...
  PluginLogger,
} from "qcortex/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "qcortex/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: QCortexPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: QCortexPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
