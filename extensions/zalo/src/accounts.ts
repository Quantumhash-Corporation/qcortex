...
} from "qcortex/plugin-sdk/account-id";
import type { QCortexConfig } from "qcortex/plugin-sdk/zalo";
...
export function listZaloAccountIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: QCortexConfig): string {
...
function mergeZaloAccountConfig(cfg: QCortexConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: QCortexConfig): ResolvedZaloAccount[] {
