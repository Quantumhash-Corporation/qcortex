/**
 * Twitch channel plugin for QCortex.
 *
 * Main plugin export combining all adapters (outbound, actions, status, gateway).
 * This is the primary entry point for the Twitch channel integration.
 */

import type { QCortexConfig } from "qcortex/plugin-sdk/twitch";
import { buildChannelConfigSchema } from "qcortex/plugin-sdk/twitch";
 ...
 * for QCortex. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: QCortexConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: QCortexConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: QCortexConfig): boolean => {
