...
import type { ReplyPayload, QCortexConfig } from "qcortex/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "qcortex/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as QCortexConfig;
