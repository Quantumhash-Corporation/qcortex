...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "qcortex/plugin-sdk/msteams";
...
import { resolvePreferredQCortexTmpDir } from "../../../src/infra/tmp-qcortex-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredQCortexTmpDir(), "msteams-mention-"));
