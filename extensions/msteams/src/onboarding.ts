import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "qcortex/plugin-sdk/msteams";
import {
...
function setMSTeamsDmPolicy(cfg: QCortexConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: QCortexConfig, allowFrom: string[]): QCortexConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
