import type { QCortexConfig, DmPolicy } from "qcortex/plugin-sdk/googlechat";
import {
...
} from "qcortex/plugin-sdk/googlechat";
import {
...
function setGoogleChatDmPolicy(cfg: QCortexConfig, policy: DmPolicy) {
  const allowFrom =
    policy === "open"
