...
import { isSecretRef } from "qcortex/plugin-sdk/googlechat";
import type { QCortexConfig } from "qcortex/plugin-sdk/googlechat";
...
export function listGoogleChatAccountIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: QCortexConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: QCortexConfig): ResolvedGoogleChatAccount[] {
