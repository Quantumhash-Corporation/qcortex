...
import type { QCortexConfig } from "qcortex/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: QCortexConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: QCortexConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: QCortexConfig): string {
