import type { QCortexConfig, QCortexPluginApi } from "qcortex/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: QCortexConfig): { id: string; name: string } {
