...
import type { QCortexPluginApi } from "qcortex/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: QCortexPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<QCortexPluginApi, "config">;
