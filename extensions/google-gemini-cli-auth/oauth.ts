...
import { fetchWithSsrFGuard, isWSL2Sync } from "qcortex/plugin-sdk/google-gemini-cli-auth";

const CLIENT_ID_KEYS = ["QCORTEX_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = ["QCORTEX_GEMINI_OAUTH_CLIENT_SECRET", "GEMINI_CLI_OAUTH_CLIENT_SECRET"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to QCortex.</p></body></html>",
        );
