import type { QCortexPluginApi } from "qcortex/plugin-sdk/discord";
import {
  autoBindSpawnedDiscordSubagent,
  listThreadBindingsBySessionKey,
  resolveDiscordAccount,
  unbindThreadBindingsBySessionKey,
} from "qcortex/plugin-sdk/discord";
...
export function registerDiscordSubagentHooks(api: QCortexPluginApi) {
