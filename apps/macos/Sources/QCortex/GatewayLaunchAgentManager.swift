...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.qcortex", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".qcortex/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.qcortexCommand(
            subcommand: "gateway",
