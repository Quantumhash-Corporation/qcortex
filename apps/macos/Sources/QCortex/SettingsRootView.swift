...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .qcortexSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? QCortexPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? QCortexPaths.stateDirURL.path
...
extension Notification.Name {
    static let qcortexSelectSettingsTab = Notification.Name("qcortexSelectSettingsTab")
}
