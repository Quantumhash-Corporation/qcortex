...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.qcortex", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("QCortex/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__qcortex__/a2ui/").absoluteString + "?platform=macos"
    }
