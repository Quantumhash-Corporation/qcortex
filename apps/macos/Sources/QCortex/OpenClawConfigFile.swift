...
enum QCortexConfigFile {
    private static let logger = Logger(subsystem: "ai.qcortex", category: "config")
    ...
    static func stateDirURL() -> URL {
        QCortexPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        QCortexPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-qcortex-config-file",
            "event": "config.write",
