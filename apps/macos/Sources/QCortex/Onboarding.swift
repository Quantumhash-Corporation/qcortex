...
enum UIStrings {
    static let welcomeTitle = "Welcome to QCortex"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "qcortex.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: QCortexChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g qcortex@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: QCortexChatViewModel(
