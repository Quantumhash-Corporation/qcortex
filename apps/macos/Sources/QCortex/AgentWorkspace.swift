...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.qcortex", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return QCortexConfigFile.defaultWorkspaceURL() }
