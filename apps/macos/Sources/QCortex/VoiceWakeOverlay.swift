...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.qcortex", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other QCortex windows, but below the system’s pop-up menus.
