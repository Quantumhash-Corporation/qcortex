...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/qcortex/qcortex") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/qcortex/qcortex")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://qcortex.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "QCortexBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "QCortexBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "QCortexGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "QCortexGitCommit") as? String) ??
            "unknown"
    }
