...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.qcortex", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.qcortex", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [QCortexChatMessage] = messages.compactMap { item in
