...
/// Menu contents for the QCortex menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About QCortex") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "QCortex Not Configured"
        case .remote:
            "Remote QCortex Active"
        case .local:
            "QCortex Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .qcortexSelectSettingsTab, object: tab)
        }
    }
