...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = QCortexConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = QCortexConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = QCortexConfigFile.loadDict()
            ...
            QCortexConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/qcortex"
        state.remoteCliPath = ""
        return state
    }
}
