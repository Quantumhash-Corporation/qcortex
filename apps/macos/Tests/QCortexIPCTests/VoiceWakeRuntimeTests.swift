...
@Suite struct VoiceWakeRuntimeTests {
    ...
    @Test func hasContentAfterTriggerFalseWhenOnlyTrigger() {
        let triggers = ["qcortex"]
        let text = "hey qcortex"
    ...
    @Test func gateRequiresGapBetweenTriggerAndCommand() {
        let transcript = "hey qcortex do thing"
        ...
        let config = WakeWordGateConfig(triggers: ["qcortex"], minPostTriggerGap: 0.3)
