...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.qcortex.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to QCortex", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to QCortex gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to QCortex.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "QCortexShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "QCortex is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "QCortex Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("qcortex-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
