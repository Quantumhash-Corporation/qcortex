...
@MainActor
final class QCortexAppDelegate: NSObject, UIApplicationDelegate, @preconcurrency UNUserNotificationCenterDelegate {
    private let logger = Logger(subsystem: "ai.qcortex.ios", category: "Push")
    private let backgroundWakeLogger = Logger(subsystem: "ai.qcortex.ios", category: "BackgroundWake")
    private static let wakeRefreshTaskIdentifier = "ai.qcortex.ios.bgrefresh"
...
enum WatchPromptNotificationBridge {
    static let typeKey = "qcortex.type"
    static let typeValue = "watch.prompt"
    static let promptIDKey = "qcortex.watch.promptId"
    static let sessionKeyKey = "qcortex.watch.sessionKey"
    static let actionPrimaryIDKey = "qcortex.watch.action.primary.id"
    static let actionPrimaryLabelKey = "qcortex.watch.action.primary.label"
    static let actionSecondaryIDKey = "qcortex.watch.action.secondary.id"
    static let actionSecondaryLabelKey = "qcortex.watch.action.secondary.label"
    static let actionPrimaryIdentifier = "qcortex.watch.action.primary"
    static let actionSecondaryIdentifier = "qcortex.watch.action.secondary"
    static let actionIdentifierPrefix = "qcortex.watch.action."
    static let actionIDKeyPrefix = "qcortex.watch.action.id."
    static let actionLabelKeyPrefix = "qcortex.watch.action.label."
    static let categoryPrefix = "qcortex.watch.prompt.category."

    @MainActor
    static func scheduleMirroredWatchPromptNotificationIfNeeded(
        invokeID: String,
        params: QCortexWatchNotifyParams,
        sendResult: WatchNotificationSendResult) async
    {
        ...
        let normalizedActions = (params.actions ?? []).compactMap { action -> QCortexWatchAction? in
            let id = action.id.trimmingCharacters(in: .whitespacesAndNewlines)
            let label = action.label.trimmingCharacters(in: .whitespacesAndNewlines)
            guard !id.isEmpty, !label.isEmpty else { return nil }
            return QCortexWatchAction(id: id, label: label, style: action.style)
        }
        ...
        content.title = title.isEmpty ? "QCortex" : title
        content.body = body
    ...
    private static func categoryActions(_ actions: [QCortexWatchAction]) -> [UNNotificationAction] {
...
@main
struct QCortexApp: App {
    @State private var appModel: NodeAppModel
    @State private var gatewayController: GatewayConnectionController
    @UIApplicationDelegateAdaptor(QCortexAppDelegate.self) private var appDelegate
...
extension QCortexApp {
    private static func installUncaughtExceptionLogger() {
        NSLog("QCortex: installing uncaught exception handler")
