...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: QCortexPhotosLatestParams) async throws -> QCortexPhotosLatestPayload {
        ...
        var results: [QCortexPhotoPayload] = []
        ...
        return QCortexPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> QCortexPhotoPayload
    {
