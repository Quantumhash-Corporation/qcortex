...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = QCortexLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = QCortexLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.qcortex.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected QCortex agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for QCortex. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(QCortexLocationMode.off.rawValue)
                            Text("While Using").tag(QCortexLocationMode.whileUsing.rawValue)
                            Text("Always").tag(QCortexLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while QCortex is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("QCortex", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = QCortexLocationMode(rawValue: newValue) else { return }
                Task {
