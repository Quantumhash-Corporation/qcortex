...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.qcortex.gateway"
    private static let nodeService = "ai.qcortex.node"
    private static let talkService = "ai.qcortex.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.qcortex.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.qcortex.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("qcortex-gateway.log")
    }
