...
public enum QCortexTalkCommand: String, Codable, Sendable {
...
public struct QCortexTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct QCortexTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
