...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: QCortexProtocol.AnyCodable]?
    {
        ...
        return [
            "id": QCortexProtocol.AnyCodable(identity.deviceId),
            "publicKey": QCortexProtocol.AnyCodable(publicKey),
            "signature": QCortexProtocol.AnyCodable(signature),
            "signedAt": QCortexProtocol.AnyCodable(signedAtMs),
            "nonce": QCortexProtocol.AnyCodable(nonce),
        ]
    }
}
