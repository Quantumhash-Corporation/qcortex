...
public enum QCortexCanvasA2UICommand: String, Codable, Sendable {
...
public struct QCortexCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct QCortexCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
