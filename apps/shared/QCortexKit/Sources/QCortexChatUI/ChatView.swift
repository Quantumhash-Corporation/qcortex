...
@MainActor
public struct QCortexChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: QCortexChatViewModel
    ...
    public init(
        viewModel: QCortexChatViewModel,
    ...
    private var visibleMessages: [QCortexChatMessage] {
        let base: [QCortexChatMessage]
    ...
    private func mergeToolResults(in messages: [QCortexChatMessage]) -> [QCortexChatMessage] {
    ...
    private func isToolResultMessage(_ message: QCortexChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: QCortexChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: QCortexChatMessage) -> String {
