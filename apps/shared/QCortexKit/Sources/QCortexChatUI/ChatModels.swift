...
public typealias QCortexPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias QCortexPlatformImage = UIImage
#endif

public struct QCortexChatUsageCost: Codable, Hashable, Sendable {
...
public struct QCortexChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: QCortexChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(QCortexChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct QCortexChatMessageContent: Codable, Hashable, Sendable {
...
public struct QCortexChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [QCortexChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: QCortexChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [QCortexChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: QCortexChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(QCortexChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([QCortexChatMessageContent].self, forKey: .content) {
...
public struct QCortexChatHistoryPayload: Codable, Sendable {
...
public struct QCortexSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct QCortexSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [QCortexSessionPreviewItem]
}

public struct QCortexSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [QCortexSessionPreviewEntry]

    public init(ts: Int, previews: [QCortexSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct QCortexChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct QCortexChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct QCortexAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct QCortexChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct QCortexGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct QCortexPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: QCortexPlatformImage?
...
public struct QCortexChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
