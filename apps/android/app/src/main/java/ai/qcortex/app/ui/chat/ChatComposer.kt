...
import ai.qcortex.app.ui.mobileSurface
import ai.qcortex.app.ui.mobileText
import ai.qcortex.app.ui.mobileTextSecondary
import ai.qcortex.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.qcortex.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.qcortex.app.ui.mobileFontFamily,
