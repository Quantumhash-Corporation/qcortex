...
function mergeSignalAccountConfig(cfg: QCortexConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: QCortexConfig): ResolvedSignalAccount[] {
