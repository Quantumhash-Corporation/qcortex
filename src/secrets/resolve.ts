...
function resolveResolutionLimits(config: QCortexConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: QCortexConfig): SecretProviderConfig {
