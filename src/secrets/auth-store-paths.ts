...
export function listAuthProfileStorePaths(config: QCortexConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: QCortexConfig, stateDir: string): string[] {
