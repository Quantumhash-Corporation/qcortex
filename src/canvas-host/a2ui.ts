...
export const A2UI_PATH = "/__qcortex__/a2ui";

export const CANVAS_HOST_PATH = "/__qcortex__/canvas";

export const CANVAS_WS_PATH = "/__qcortex__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.qcortexCanvasA2UIAction.postMessage(...)
  // - Android: window.qcortexCanvasA2UIAction.postMessage(...)
  const handlerNames = ["qcortexCanvasA2UIAction"];
  ...
  globalThis.QCortex = globalThis.QCortex ?? {};
  globalThis.QCortex.postMessage = postToNode;
  globalThis.QCortex.sendUserAction = sendUserAction;
  globalThis.qcortexPostMessage = postToNode;
  globalThis.qcortexSendUserAction = sendUserAction;
