...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.QCORTEX_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: QCortexConfig): string[] {
...
export function listTelegramAccountIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: QCortexConfig): string {
...
function mergeTelegramAccountConfig(cfg: QCortexConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/qcortex/qcortex/issues/30673
...
export function listEnabledTelegramAccounts(cfg: QCortexConfig): ResolvedTelegramAccount[] {
