...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "qcortex-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["QCORTEX_BUNDLED_HOOKS_DIR"]);
    process.env.QCORTEX_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: QCortexConfig) => {
