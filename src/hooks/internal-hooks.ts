/**
 * Hook system for QCortex agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __qcortex_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__qcortex_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
