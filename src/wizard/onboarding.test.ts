...
vi.mock("../commands/onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "/tmp/qcortex-workspace",
...
describe("runOnboardingWizard", () => {
  ...
  beforeAll(async () => {
    suiteRoot = await fs.mkdtemp(path.join(os.tmpdir(), "qcortex-onboard-suite-"));
  });
  ...
  it("resolves gateway.auth.password SecretRef for local onboarding probe", async () => {
    ...
    process.env.QCORTEX_GATEWAY_PASSWORD = "gateway-ref-password";
