...
function resolveAcpStreamCoalesceIdleMs(cfg: QCortexConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: QCortexConfig): number {
...
export function resolveAcpProjectionSettings(cfg: QCortexConfig): AcpProjectionSettings {
