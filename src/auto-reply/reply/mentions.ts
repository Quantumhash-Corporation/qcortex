...
function resolveMentionPatterns(cfg: QCortexConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: QCortexConfig | undefined, agentId?: string): RegExp[] {
