...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@qcortex", { botUsername: "qcortex" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@qcortex args", {
        botUsername: "qcortex",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "qcortex" })).toBe(
      "/help@otherbot",
    );
  });
