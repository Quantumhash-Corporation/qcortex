...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.qcortex.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", QCORTEX_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.qcortex.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.qcortex.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when QCORTEX_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.qcortex.gateway.plist",
    },
    {
      name: "uses profile-specific label when QCORTEX_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", QCORTEX_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.qcortex.jbphoenix.plist",
    },
    {
      name: "prefers QCORTEX_LAUNCHD_LABEL over QCORTEX_PROFILE",
      env: {
        HOME: "/Users/test",
        QCORTEX_PROFILE: "jbphoenix",
        QCORTEX_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from QCORTEX_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        QCORTEX_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty QCORTEX_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        QCORTEX_PROFILE: "myprofile",
        QCORTEX_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.qcortex.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
