...
function resolveAdaptiveReadMaxBytes(options?: QCortexReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createQCortexReadTool(base, {
...
export function createQCortexReadTool(
  base: AnyAgentTool,
  options?: QCortexReadToolOptions,
): AnyAgentTool {
