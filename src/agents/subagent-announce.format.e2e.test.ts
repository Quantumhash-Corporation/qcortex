...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/qcortex/qcortex/issues/31298
    previousFastTestEnv = process.env.QCORTEX_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.QCORTEX_TEST_FAST;
      return;
    }
    process.env.QCORTEX_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // QCORTEX_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("QCortex runtime context (internal):");
