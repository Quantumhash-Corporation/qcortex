...
function resolveWatchPaths(workspaceDir: string, config?: QCortexConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: QCortexConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: QCortexConfig }) {
