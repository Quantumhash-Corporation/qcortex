...
async function resolveContext(config: QCortexConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): QCortexConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
