...
const CLEANUP_STATE_KEY = Symbol.for("qcortex.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("qcortex.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("qcortex.sessionWriteLockWatchdogState");
