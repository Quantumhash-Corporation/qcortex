...
export const DEFAULT_SANDBOX_IMAGE = "qcortex-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "qcortex-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "qcortex-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "qcortex-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "qcortex-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "qcortex-sandbox-browser";
