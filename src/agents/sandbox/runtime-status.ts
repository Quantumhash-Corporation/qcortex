...
function resolveMainSessionKeyForSandbox(params: { cfg?: QCortexConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: QCortexConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`qcortex sandbox explain --session ${runtime.sessionKey}`)}`,
  );
