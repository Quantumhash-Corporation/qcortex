...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveQCortexAgentDir() returns mainAgentDir
    process.env.QCORTEX_STATE_DIR = tmpDir;
    process.env.QCORTEX_AGENT_DIR = mainAgentDir;
