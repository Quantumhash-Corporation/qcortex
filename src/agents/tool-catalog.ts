...
function buildCoreToolGroupMap() {
  ...
  const qcortexTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInQCortexGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:qcortex": qcortexTools,
