...
function asQCortexConfig(config: Partial<QCortexConfig>): QCortexConfig {
  return config as QCortexConfig;
}

function createToolConfig() {
  return asQCortexConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: QCortexConfig = createToolConfig()) {
