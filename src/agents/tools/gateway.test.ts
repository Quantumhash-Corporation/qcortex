...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    qcortex: process.env.QCORTEX_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.qcortex === undefined) {
      delete process.env.QCORTEX_GATEWAY_TOKEN;
    } else {
      process.env.QCORTEX_GATEWAY_TOKEN = envSnapshot.qcortex;
    }
  ...
  it("uses QCORTEX_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.QCORTEX_GATEWAY_TOKEN = "local-env-token";
