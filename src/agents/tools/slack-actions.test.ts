...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): QCortexConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: QCortexConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: QCortexConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
