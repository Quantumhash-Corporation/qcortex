...
function resolveMemoryToolContext(options: { config?: QCortexConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: QCortexConfig): MemoryCitationsMode {
