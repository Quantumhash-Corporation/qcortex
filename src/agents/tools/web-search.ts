...
type WebSearchConfig = NonNullable<QCortexConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: QCortexConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("qcortex configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.qcortex.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://qcortex.ai",
          "X-Title": "QCortex Web Search",
        },
