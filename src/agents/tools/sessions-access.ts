...
export function resolveSessionToolsVisibility(cfg: QCortexConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: QCortexConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: QCortexConfig): AgentToAgentPolicy {
