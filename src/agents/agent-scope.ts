...
type AgentEntry = NonNullable<NonNullable<QCortexConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: QCortexConfig): AgentEntry[] {
...
export function listAgentIds(cfg: QCortexConfig): string[] {
...
export function resolveDefaultAgentId(cfg: QCortexConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: QCortexConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: QCortexConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: QCortexConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: QCortexConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
