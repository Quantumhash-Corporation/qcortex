...
function resolveAvatarSource(cfg: QCortexConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: QCortexConfig, agentId: string): AgentAvatarResolution {
