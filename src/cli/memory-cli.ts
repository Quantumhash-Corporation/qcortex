    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["qcortex memory status", "Show index and provider status."],
          ["qcortex memory index --force", "Force a full reindex."],
          ['qcortex memory search --query "deployment notes"', "Search indexed memory entries."],
          ["qcortex memory status --json", "Output machine-readable JSON."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.qcortex.ai/cli/memory")}\n`,
    );
