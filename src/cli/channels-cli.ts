    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["qcortex channels list", "List configured channels and auth profiles."],
          ["qcortex channels status --probe", "Run channel status checks and probes."],
          [
            "qcortex channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["qcortex channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.qcortex.ai/cli/channels",
        )}\n`,
    );
