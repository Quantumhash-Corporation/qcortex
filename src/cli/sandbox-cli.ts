...
const SANDBOX_EXAMPLES = {
  main: [
    ["qcortex sandbox list", "List all sandbox containers."],
    ["qcortex sandbox list --browser", "List only browser containers."],
    ["qcortex sandbox recreate --all", "Recreate all containers."],
    ["qcortex sandbox recreate --session main", "Recreate a specific session."],
    ["qcortex sandbox recreate --agent mybot", "Recreate agent containers."],
    ["qcortex sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["qcortex sandbox list", "List all sandbox containers."],
    ["qcortex sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["qcortex sandbox recreate --all", "Recreate all containers."],
    ["qcortex sandbox recreate --session main", "Recreate a specific session."],
    ["qcortex sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["qcortex sandbox recreate --browser --all", "Recreate only browser containers."],
    ["qcortex sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["qcortex sandbox explain", "Show effective sandbox config."],
    ["qcortex sandbox explain --session agent:main:main", "Explain a specific session."],
    ["qcortex sandbox explain --agent work", "Explain an agent sandbox."],
    ["qcortex sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.qcortex.ai/cli/sandbox")}\n`,
    )
    .action(() => {
