    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["qcortex directory self --channel slack", "Show the connected account identity."],
          [
            'qcortex directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["qcortex directory groups list --channel discord", "List available groups/channels."],
          [
            "qcortex directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.qcortex.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
