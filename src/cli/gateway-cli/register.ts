      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["qcortex gateway run", "Run the gateway in the foreground."],
            ["qcortex gateway status", "Show service status and probe reachability."],
            ["qcortex gateway discover", "Find local and wide-area gateway beacons."],
            ["qcortex gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.qcortex.ai/cli/gateway")}\n`,
      ),
  );
