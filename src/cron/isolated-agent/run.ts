...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/qcortex/qcortex/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.QCORTEX_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.qcortex/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: QCortexConfig = {
    ...params.cfg,
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: async (providerOverride, modelOverride, runOptions) => {
          ...
          if (isCliProvider(providerOverride, cfgWithAgentDefaults)) {
            ...
            // the configured timeoutSeconds. See: https://github.com/qcortex/qcortex/issues/29774
