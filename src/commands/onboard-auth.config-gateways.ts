...
export function applyVercelAiGatewayProviderConfig(cfg: QCortexConfig): QCortexConfig {
...
export function applyVercelAiGatewayConfig(cfg: QCortexConfig): QCortexConfig {
