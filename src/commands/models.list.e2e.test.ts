...
const ensureQCortexModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveQCortexAgentDir = vi.fn().mockReturnValue("/tmp/qcortex-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/qcortex-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureQCortexModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveQCortexAgentDir,
}));
