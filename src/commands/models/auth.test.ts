...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: QCortexConfig;
  let lastUpdatedConfig: QCortexConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/qcortex/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/qcortex/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/qcortex/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: QCortexConfig) => QCortexConfig) => {
