...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.qcortex.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("qcortex hooks list")}`,
      `  ${formatCliCommand("qcortex hooks enable <name>")}`,
      `  ${formatCliCommand("qcortex hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
