...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "tinyfish-api-key": {
    ...
    expectedProviders: ["tinyfish"],
    envLabel: "TINYFISH_API_KEY",
    promptMessage: "Enter Tinyfish API key",
    setCredential: setTinyfishApiKey,
    defaultModel: "openai-codex/gpt-5.4",
    applyDefaultConfig: (cfg) => cfg,
    applyProviderConfig: (cfg) => cfg,
    noteMessage: [
      "Tinyfish is a web automation agent for browser tasks.",
      "Get your API key at: https://app.tinyfish.ai",
    ].join("\n"),
    noteTitle: "Tinyfish Web Agent",
  },
  "mistral-api-key": {
    provider: "mistral",
