...
export function hasAmbiguousGatewayAuthModeConfig(cfg: QCortexConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: QCortexConfig): void {
