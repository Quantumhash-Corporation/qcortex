import type { GatewayAuthConfig, QCortexConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { secretRefKey } from "../secrets/ref-contract.js";
import { resolveSecretRefValues } from "../secrets/resolve.js";

export function withGatewayAuthPassword(cfg: QCortexConfig, password: string): QCortexConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
