...
function cfg(input: Partial<QCortexConfig>): QCortexConfig {
  return input as QCortexConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<QCortexConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  ...
  QCORTEX_GATEWAY_PASSWORD: "env-password",
