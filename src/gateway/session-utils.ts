...
import { type QCortexConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: QCortexConfig): string[] {
...
export function listAgentsForGateway(cfg: QCortexConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: QCortexConfig): string {
...
function resolveSessionStoreAgentId(cfg: QCortexConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: QCortexConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: QCortexConfig): GatewaySessionsDefaults {
