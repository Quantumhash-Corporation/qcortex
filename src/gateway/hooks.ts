...
export function resolveHooksConfig(cfg: QCortexConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: QCortexConfig, defaultAgentId: string): Set<string> {
