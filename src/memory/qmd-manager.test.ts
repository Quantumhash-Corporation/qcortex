...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: QCortexConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: QCortexConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__qcortexMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__qcortexMcporterColdStartWarned;
  });
