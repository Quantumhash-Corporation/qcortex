...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/qcortex/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/qcortex/extensions",
        global: "/Users/x/.qcortex/extensions",
        workspace: "/Users/x/ws/.qcortex/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.qcortex/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/qcortex/extensions",
        global: "/Users/x/.qcortex/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.qcortex/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/qcortex/extensions",
        global: "/Users/x/.qcortex/extensions",
