...
import type {
  QCortexPluginApi,
  QCortexPluginChannelRegistration,
  QCortexPluginCliRegistrar,
  QCortexPluginCommandDefinition,
  QCortexPluginHttpRouteAuth,
  QCortexPluginHttpRouteMatch,
  QCortexPluginHttpRouteHandler,
  QCortexPluginHttpRouteParams,
  QCortexPluginHookOptions,
  ProviderPlugin,
  QCortexPluginService,
  QCortexPluginToolContext,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: QCortexPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: QCortexPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: QCortexPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: QCortexPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: QCortexPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: QCortexPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: QCortexPluginHookOptions | undefined,
    config: QCortexPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: QCortexPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: QCortexPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as QCortexPluginChannelRegistration).plugin === "object"
        ? (registration as QCortexPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: QCortexPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: QCortexPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: QCortexPluginCommandDefinition) => {
