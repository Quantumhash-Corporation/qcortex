...
export const PLUGIN_MANIFEST_FILENAME = "qcortex.plugin.json";
...
// package.json "qcortex" metadata (used for onboarding/catalog)
...
export type QCortexPackageManifest = {
  extensions?: string[];
...
): QCortexPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
