...
export type QCortexPluginConfigSchema = {
...
export type QCortexPluginToolContext = {
...
export type QCortexPluginToolFactory = (
  ctx: QCortexPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type QCortexPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type QCortexPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<QCortexConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type QCortexPluginGatewayMethod = {
  method: string;
 ...
 */
export type QCortexPluginCommandDefinition = {
...
export type QCortexPluginHttpRouteAuth = "gateway" | "plugin";
export type QCortexPluginHttpRouteMatch = "exact" | "prefix";

export type QCortexPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type QCortexPluginHttpRouteParams = {
  path: string;
  handler: QCortexPluginHttpRouteHandler;
  auth: QCortexPluginHttpRouteAuth;
  match?: QCortexPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type QCortexPluginCliContext = {
  program: Command;
  config: QCortexConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type QCortexPluginCliRegistrar = (ctx: QCortexPluginCliContext) => void | Promise<void>;

export type QCortexPluginServiceContext = {
  config: QCortexConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type QCortexPluginService = {
  id: string;
  start: (ctx: QCortexPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: QCortexPluginServiceContext) => void | Promise<void>;
};

export type QCortexPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type QCortexPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: QCortexPluginConfigSchema;
  register?: (api: QCortexPluginApi) => void | Promise<void>;
  activate?: (api: QCortexPluginApi) => void | Promise<void>;
};

export type QCortexPluginModule =
  | QCortexPluginDefinition
  | ((api: QCortexPluginApi) => void | Promise<void>);

export type QCortexPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | QCortexPluginToolFactory,
    opts?: QCortexPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: QCortexPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: QCortexPluginHttpRouteParams) => void;
  registerChannel: (registration: QCortexPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: QCortexPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: QCortexPluginService) => void;
   ...
   */
  registerCommand: (command: QCortexPluginCommandDefinition) => void;
