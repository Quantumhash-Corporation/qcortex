...
const loadQCortexPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadQCortexPlugins: (params: unknown) => loadQCortexPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadQCortexPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadQCortexPluginsMock.mockClear();
  });
