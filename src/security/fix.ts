...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof QCortexConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: QCortexConfig; env: NodeJS.ProcessEnv }): {
  cfg: QCortexConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
