...
export function listBindings(cfg: QCortexConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: QCortexConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: QCortexConfig) {
