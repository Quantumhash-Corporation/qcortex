...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: QCortexConfig): string | undefined {
  ...
  function listAccountIds(cfg: QCortexConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: QCortexConfig): string {
