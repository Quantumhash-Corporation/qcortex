...
export type ChannelAgentToolFactory = (params: { cfg?: QCortexConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: QCortexConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: QCortexConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: QCortexConfig }) => boolean;
  supportsCards?: (params: { cfg: QCortexConfig }) => boolean;
