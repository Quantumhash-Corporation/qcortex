...
export function listChannelMessageActions(cfg: QCortexConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: QCortexConfig): boolean {
...
export function supportsChannelMessageCards(cfg: QCortexConfig): boolean {
