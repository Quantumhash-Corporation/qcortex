...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: QCortexConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: QCortexConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: QCortexConfig) => string;
  setAccountEnabled?: (params: {
    cfg: QCortexConfig;
    accountId: string;
    enabled: boolean;
  }) => QCortexConfig;
  deleteAccount?: (params: { cfg: QCortexConfig; accountId: string }) => QCortexConfig;
  isEnabled?: (account: ResolvedAccount, cfg: QCortexConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: QCortexConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: QCortexConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: QCortexConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: QCortexConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.qcortex.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: QCortexConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
