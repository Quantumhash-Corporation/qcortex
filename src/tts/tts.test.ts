...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.QCORTEX_TTS_PREFS;
      process.env.QCORTEX_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.QCORTEX_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: QCortexConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
