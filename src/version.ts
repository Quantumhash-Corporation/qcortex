...
declare const __QCORTEX_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "qcortex";
...
export function resolveRuntimeServiceVersion(
  ...
  return (
    firstNonEmpty(
      env["QCORTEX_VERSION"],
      runtimeVersion,
      env["QCORTEX_SERVICE_VERSION"],
      env["npm_package_version"],
    ) ?? fallback
  );
}

// Single source of truth for the current QCortex version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION = resolveBinaryVersion({
  moduleUrl: import.meta.url,
  injectedVersion: typeof __QCORTEX_VERSION__ === "string" ? __QCORTEX_VERSION__ : undefined,
  bundledVersion: process.env.QCORTEX_BUNDLED_VERSION,
});
