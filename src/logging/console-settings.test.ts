...
let originalQCortexTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalQCortexTestConsole = process.env.QCORTEX_TEST_CONSOLE;
  process.env.QCORTEX_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalQCortexTestConsole === undefined) {
    delete process.env.QCORTEX_TEST_CONSOLE;
  } else {
    process.env.QCORTEX_TEST_CONSOLE = originalQCortexTestConsole;
  }
