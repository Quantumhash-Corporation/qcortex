...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: QCortexConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: QCortexConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: QCortexConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: QCortexConfig }): Promise<void> {
