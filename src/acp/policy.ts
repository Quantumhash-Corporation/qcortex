...
export function isAcpEnabledByPolicy(cfg: QCortexConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: QCortexConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: QCortexConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: QCortexConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: QCortexConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: QCortexConfig, agentId: string): boolean {
