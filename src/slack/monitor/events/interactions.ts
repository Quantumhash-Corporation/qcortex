...
// Prefix for QCortex-generated action IDs to scope our handler
const QCORTEX_ACTION_PREFIX = "qcortex:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${QCORTEX_ACTION_PREFIX}`);

  // Handle QCortex modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
