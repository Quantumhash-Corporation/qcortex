...
function mergeSlackAccountConfig(cfg: QCortexConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: QCortexConfig): ResolvedSlackAccount[] {
