...
function mergeDiscordAccountConfig(cfg: QCortexConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: QCortexConfig): ResolvedDiscordAccount[] {
