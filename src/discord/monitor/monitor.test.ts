...
describe("agent components", () => {
  const createCfg = (): QCortexConfig => ({}) as QCortexConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/qcortex-sessions-test.json");
  });
