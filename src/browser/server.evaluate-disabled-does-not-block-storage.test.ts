  ...
  return {
    ...
    loadConfig: () => ({
      browser: {
        ...
        profiles: {
          qcortex: { cdpPort: testPort + 1, color: "#FF4500" },
        },
      },
    }),
...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.QCORTEX_GATEWAY_PORT;
    process.env.QCORTEX_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.QCORTEX_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.QCORTEX_GATEWAY_PASSWORD;
