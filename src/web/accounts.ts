...
export function listWhatsAppAuthDirs(cfg: QCortexConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: QCortexConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: QCortexConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: QCortexConfig): ResolvedWhatsAppAccount[] {
