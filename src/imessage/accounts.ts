...
function mergeIMessageAccountConfig(cfg: QCortexConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: QCortexConfig): ResolvedIMessageAccount[] {
