...
function resolveAnthropicDefaultAuthMode(cfg: QCortexConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: QCortexConfig): QCortexConfig {
...
export function applyTalkApiKey(config: QCortexConfig): QCortexConfig {
...
export function applyTalkConfigNormalization(config: QCortexConfig): QCortexConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: QCortexConfig): QCortexConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: QCortexConfig): QCortexConfig {
...
export function applyLoggingDefaults(cfg: QCortexConfig): QCortexConfig {
...
export function applyContextPruningDefaults(cfg: QCortexConfig): QCortexConfig {
...
export function applyCompactionDefaults(cfg: QCortexConfig): QCortexConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
