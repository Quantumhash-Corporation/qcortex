    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">qcortex devices list</span><br />
          <span class="mono">qcortex devices approve &lt;requestId&gt;</span>
        </div>
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">qcortex dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">qcortex doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
