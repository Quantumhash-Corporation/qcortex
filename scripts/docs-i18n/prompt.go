...
- Keep product names in English: QCortex, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the QCortex Gateway, use “Gateway 网关”.
