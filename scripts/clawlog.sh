...
show_usage() {
    cat << EOF
clawlog - QCortex Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View QCortex logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    QCortex logs flow through the macOS unified log (subsystem: ai.qcortex).
