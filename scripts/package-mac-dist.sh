...
# Output:
# - dist/QCortex.app
# - dist/QCortex-<version>.zip
# - dist/QCortex-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.qcortex.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/QCortex.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/QCortex-$VERSION.zip"
DMG="$ROOT_DIR/dist/QCortex-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/QCortex-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/QCortex-$VERSION.dSYM.zip"
