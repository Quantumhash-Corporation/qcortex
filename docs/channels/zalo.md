...
- Install via CLI: `qcortex plugins install @qcortex/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `qcortex plugins install ./extensions/zalo`
   - From npm (if published): `qcortex plugins install @qcortex/zalo`
...
- Approve via:
  - `qcortex pairing list zalo`
  - `qcortex pairing approve zalo <CODE>`
...
- Example: `qcortex message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `qcortex channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `qcortex logs --follow`
