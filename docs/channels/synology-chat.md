---
summary: "Synology Chat webhook setup and QCortex config"
read_when:
  - Setting up Synology Chat with QCortex
...
```bash
qcortex plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your QCortex gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in QCortex.
...
- Pairing approvals work with:
  - `qcortex pairing list synology-chat`
  - `qcortex pairing approve synology-chat <CODE>`
...
```bash
qcortex message send --channel synology-chat --target 123456 --text "Hello from QCortex"
qcortex message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
