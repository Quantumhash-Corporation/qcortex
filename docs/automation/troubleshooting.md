...
qcortex system heartbeat last
qcortex logs --follow
qcortex config get agents.defaults.heartbeat
qcortex channels status --probe
```
...
```bash
qcortex config get agents.defaults.heartbeat.activeHours
qcortex config get agents.defaults.heartbeat.activeHours.timezone
qcortex config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
qcortex cron list
qcortex logs --follow
```
