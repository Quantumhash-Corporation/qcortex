...
QCortex ships three update channels:
...
When you **explicitly** switch channels with `--channel`, QCortex also aligns
the install method:
...
When you switch channels with `qcortex update`, QCortex also syncs plugin sources:
