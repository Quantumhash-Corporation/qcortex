...
Deploy QCortex on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/qcortex` — Control UI
...
- `QCORTEX_STATE_DIR=/data/.qcortex` (recommended)
- `QCORTEX_WORKSPACE_DIR=/data/workspace` (recommended)
- `QCORTEX_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your QCortex state + workspace so you can migrate to another host without losing config or memory.
