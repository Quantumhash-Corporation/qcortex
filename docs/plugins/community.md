...
read_when:
  - You want to publish a third-party QCortex plugin
...
This page tracks high-quality **community-maintained plugins** for QCortex.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `qcortex plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `qcortex plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect QCortex to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/qcortex-wechat`
  repo: `https://github.com/icesword0760/qcortex-wechat`
  install: `qcortex plugins install @icesword760/qcortex-wechat`
