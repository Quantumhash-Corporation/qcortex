...
read_when:
  - You are building a QCortex plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (qcortex.plugin.json)

Every plugin **must** ship a `qcortex.plugin.json` file in the **plugin root**.
QCortex uses this manifest to validate configuration **without executing plugin
