---
summary: "Overview of QCortex onboarding options and flows"
read_when:
...
QCortex supports multiple onboarding paths depending on where the Gateway runs
...
- [`qcortex onboard` command](/cli/onboard)

## macOS app onboarding

Use the QCortex app when you want a fully guided setup on macOS. Docs:
