...
本指南总结了在 QCortex 中开发 Pi 集成的合理工作流程。
...
状态存储在 QCortex 状态目录下。默认为 `~/.qcortex`。如果设置了 `QCORTEX_STATE_DIR`，则使用该目录。
...
- https://docs.qcortex.ai/testing
- https://docs.qcortex.ai/start/getting-started
