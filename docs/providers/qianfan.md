---
summary: "Use Qianfan's unified API to access many models in QCortex"
read_when:
...
3. QCortex installed on your system
...
4. Copy the API key for use with QCortex

## CLI setup

```bash
qcortex onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [QCortex Configuration](/gateway/configuration)
