...
You can point QCortex at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or QCortex
...
- [Anthropic provider](/providers/anthropic) - Native QCortex integration with Claude setup-token or API keys
