---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with QCortex"
read_when:
  - You want Xiaomi MiMo models in QCortex
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). QCortex uses
