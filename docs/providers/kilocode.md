---
summary: "Use Kilo Gateway's unified API to access many models in QCortex"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in QCortex
---
...
```bash
qcortex onboard --kilocode-api-key <key>
```
