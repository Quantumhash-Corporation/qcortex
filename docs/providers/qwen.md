---
summary: "Use Qwen OAuth (free tier) in QCortex"
read_when:
  - You want to use Qwen with QCortex
...
If you already logged in with the Qwen Code CLI, QCortex will sync credentials
