---
summary: "Use NVIDIA's OpenAI-compatible API in QCortex"
read_when:
  - You want to use NVIDIA models in QCortex
...
qcortex onboard --auth-choice skip
qcortex models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
