---
summary: "Use Synthetic's Anthropic-compatible API in QCortex"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. QCortex registers it as the
...
Note: QCortex's Anthropic client appends `/v1` to the base URL, so use
