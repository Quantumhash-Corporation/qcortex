...
QCortex treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.qcortex/settings/voicewake.json`

Shape:

```json
{ "triggers": ["qcortex", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
