...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.qcortex/qcortex.json`
...
- The script prints a `MEDIA:` line for QCortex to auto-attach on supported chat providers.
